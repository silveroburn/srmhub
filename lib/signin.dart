...
Future<int> signinCheck(String username, String password, BuildContext context) async {
  final url = Uri.parse('http://192.168.65.11:3000/userLogin');
  ...
  if (result.statusCode == 200){
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Some failure')));
    return 0;
  }
}
            ...
            children: [
              ...
              SizedBox(height: 20,),
                ...
                onPressed: () async {  
                  ...
                  var result = await signinCheck(username, password, context);
                  if (result == 1){
                    Navigator.push(
                      context, 
